        ...
        "schemes": [
            {
                ...
                "equilibrium": [p, ux, uy, uz, 0.0, 0.0],
            },
            {
                "velocities": velocities,
                ...
                "polynomials": polynomes,
                "relaxation_parameters": vs,
                "equilibrium": [ux, ux**2 + p / cte, ux * uy, ux * uz, 0.0, 0.0],
            },
            {
                "velocities": velocities,
                ...
                "polynomials": polynomes,
                "relaxation_parameters": vs,
                "equilibrium": [uy, uy * ux, uy**2 + p / cte, uy * uz, 0.0, 0.0],
            },
            {
                "velocities": velocities,
                ...
                "polynomials": polynomes,
                "relaxation_parameters": vs,
                "equilibrium": [uz, uz * ux, uz * uy, uz**2 + p / cte, 0.0, 0.0],
            },
        ],
        "init": {p: 0.0, ux: 0.0, uy: 0.0, uz: 0.0},
        "boundary_conditions": {
            0: {
                "method": {
