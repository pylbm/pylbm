...
def run(space_step, final_time, generator="numpy", sorder=None, with_plot=True):
    ...
    s_0 = 2.0  # relaxation parameter for the D1Q2
    ...
    simu_cfg_d1q2 = {
        ...
        "generator": generator,
        "parameters": {LA: la, C: velocity, SIGMA_0: 1 / s_0 - 0.5},
        "show_code": False,
    }
    ...
    if with_plot:
        ...
        l1b = axe.CurveScatter(x_d1q3, sol_d1q3.m[U], color="orange", label=r"$D_1Q_3$")
        axe.legend(
            loc="upper right",
            shadow=False,
            frameon=False,
