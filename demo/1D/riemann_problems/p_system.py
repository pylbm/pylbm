...
def run(space_step,
    ...
    s_1, s_2 = 1.9, 1.9  # relaxation parameter
    ...
    simu_cfg = {
        ...
        'schemes': [
            ...
            },
            {
                ...
                'init': {U2: (riemann_pb, (xmid, u2_left, u2_right))},
            },
        ],
        'boundary_conditions': {
            0: {'method': {
    ...
    if with_plot:
        ...
        ax1.set_label(None, r"$u_1$")
        ax1.xaxis_set_visible(False)
        ax2 = fig[1]
        ax2.axis(xmin, xmax, yminb, ymaxb)
        ax2.set_label(r"$x$", r"$u_2$")

        x = sol.domain.x
        l1a = ax1.plot(x, sol.m[U1],
                       color='navy',
                       alpha=0.5,
                       label=r'$D_1Q_2$',
                       )[0]
        ...
        l2a = ax2.plot(x, sol.m[U2],
                       color='orange',
                       alpha=0.5,
                       label=r'$D_1Q_2$',
                       )[0]
        l2e = ax2.plot(x, sole[1], width=1,
                       color='black',
                       alpha=0.5,
                       label='exact',
                       )[0]
