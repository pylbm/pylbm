...
def run(space_step,
    ...
    radius = 0.125                           # radius of the obstacle
    ...
    # sss = LA**2/3                            # square of the sound speed
    ...
    if with_plot:
        ...
        image = axe.image(vorticity(sol), cmap='jet', clim=[0, .1])
