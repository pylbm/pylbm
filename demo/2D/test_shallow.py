...
class Canvas(app.Canvas):
    ...
    def __init__(self, dico):
        ...
        print self.sol.scheme.generator.code
        print self.sol.scheme.M
        print self.sol.scheme.invM
        ...
        self.texture = gloo.Texture2D(self.ccc*(self.sol._m[0,:,:].astype(np.float32) - self.min))
    ...
    def maj(self):
        ...
        dummy = self.ccc*np.sqrt(self.sol._m[1,:,:]**2+self.sol._m[2,:,:]**2)
