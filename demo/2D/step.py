...
def run(space_step, final_time, generator="cython", sorder=None, with_plot=True):
    ...
    # parameters
    scheme_name = "Geier"
    xmin, xmax, ymin, ymax = 0.0, 4.0, 0.0, 0.5  # bounds of the domain
    ...
    if with_plot:
        ...
        ax_qx.polygon([[0, 0], [0, length], [length, length], [length, 0]], "black")
        ax_qy.polygon([[0, 0], [0, length], [length, length], [length, 0]], "black")
        ax_v.polygon(
            [[0, 0], [0, length - 1], [length - 1, length - 1], [length - 1, 0]],
            "black",
        )
